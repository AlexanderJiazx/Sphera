...
//
//  bool cv::aruco::Dictionary::identify(Mat onlyCellPixelRatio, int& idx, int& rotation, double maxCorrectionRate, float validBitIdThreshold)
//
/**
 ...
 * Returns reference to the marker id in the dictionary (if any) and its rotation.
 */
- (BOOL)identify:(Mat*)onlyCellPixelRatio idx:(int*)idx rotation:(int*)rotation maxCorrectionRate:(double)maxCorrectionRate validBitIdThreshold:(float)validBitIdThreshold NS_SWIFT_NAME(identify(onlyCellPixelRatio:idx:rotation:maxCorrectionRate:validBitIdThreshold:));
...
//
//  int cv::aruco::Dictionary::getDistanceToId(Mat onlyCellPixelRatio, int id, bool allRotations, float validBitIdThreshold)
//
/**
 ...
 */
- (int)getDistanceToId:(Mat*)onlyCellPixelRatio id:(int)id allRotations:(BOOL)allRotations validBitIdThreshold:(float)validBitIdThreshold NS_SWIFT_NAME(getDistanceToId(onlyCellPixelRatio:id:allRotations:validBitIdThreshold:));
...
//
//  Mat cv::aruco::Dictionary::getMarkerBits(int markerId, int rotationId = 0)
//
/**
 * Get ground truth bits float
 */
- (Mat*)getMarkerBits:(int)markerId rotationId:(int)rotationId NS_SWIFT_NAME(getMarkerBits(markerId:rotationId:));

/**
 * Get ground truth bits float
 */
- (Mat*)getMarkerBits:(int)markerId NS_SWIFT_NAME(getMarkerBits(markerId:));
