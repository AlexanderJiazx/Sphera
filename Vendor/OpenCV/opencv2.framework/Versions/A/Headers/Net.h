 ...
 *
 * - SeeAlso setNetInputs(), Layer::inputNameToIndex(), Layer::outputNameToIndex()
 */
 ...
 *
 * - SeeAlso connect(String, String) to know format of the descriptor.
 *
