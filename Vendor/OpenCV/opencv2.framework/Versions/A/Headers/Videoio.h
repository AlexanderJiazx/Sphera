...
@property (class, readonly) int CAP_PROP_GIGA_FRAME_HEIGHT_MAX NS_SWIFT_NAME(CAP_PROP_GIGA_FRAME_HEIGHT_MAX);
...
@property (class, readonly) int CAP_PROP_GIGA_FRAME_SENS_HEIGHT NS_SWIFT_NAME(CAP_PROP_GIGA_FRAME_SENS_HEIGHT);
